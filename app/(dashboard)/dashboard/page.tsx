  ...
  return (
    <div className="mx-auto max-w-6xl space-y-8 pb-12">
      ...
      <section className="nordea-card overflow-hidden" aria-labelledby="campaigns-title">
        ...
        {!loading && !error && campaigns.slice(0, 5).map((campaign) => <Link key={campaign.id} href={campaign.brief_id ? `/create/brief/${campaign.brief_id}` : "/templates"} className="flex flex-wrap items-center justify-between gap-3 border-b border-nordea-border px-5 py-4 last:border-b-0 hover:bg-nordea-blue-soft/40">
